...
- SHOULD prioritize latests known stable versions of libraries and packages
- SHOULD store docs in docs/ and not in the root of the repo unless its a readme, license, contributing, or code of conduct file
